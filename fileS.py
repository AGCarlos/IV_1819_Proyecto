...
class FileDownload:
    ...
    def conexion(self,mode):
        ...
        if mode == "l":
            ...
            r = redis.from_url(os.environ.get(bytes("redis://h:p90d63f49afeefa17c338b0345f951b144e3f5e9bd649b4a2e625c3513fd1a5c6@ec2-52-54-174-93.compute-1.amazonaws.com:42199")))
            return r
